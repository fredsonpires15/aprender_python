from gerador_nif import Ui_MainWindow
...
class MainWindow(QMainWindow, Ui_MainWindow):
    def __init__(self):
        ...
        self.btn_nif.clicked.connect(self.gerrar_nif)
        # self.btn_validar.clicked.connect(self.validaar)
        self.btn_cpf.clicked.connect(self.gerrar_cpf)
