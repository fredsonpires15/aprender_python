...
def menu():
    ...
    print(f' |{"-"*42}|')
    #print(f' |{"="*18} MENU {"="*18}|')
    print(' |  [\033[1;36m 1 \033[0;0m] \033[1;32m Depósitos \033[0;0m                       |')
    print(' |  [\033[1;36m 2 \033[0;0m] \033[1;32m Saques \033[0;0m                          |')
    print(' |  [\033[1;36m 3 \033[0;0m] \033[1;32m Transferências \033[0;0m                  |') 
    print(' |  [\033[1;36m 4 \033[0;0m] \033[1;32m Dados de Cliente \033[0;0m                |')                                 
