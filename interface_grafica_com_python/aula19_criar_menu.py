...
class JanelaWrincipal(QMainWindow):
    def __init__(self):
        ...
        # criar menu
        menu = self.menuBar()
        menu_arquivo = menu.addMenu('Arquivo')  # nome
        menu_arquivo.addAction(btn_acao)  #
        menu_arquivo.addSeparator()  # separador
        menu_arquivo.addAction(btn_acao2)

        # criar Submenu
        submenu = menu_arquivo.addMenu('Submenu')
        submenu.addAction(btn_acao2)
