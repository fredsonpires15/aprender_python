...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        button.clicked.connect(self.mostrar_pergunta)
    ...
    def mostrar_pergunta(self):
        ...
        self.msg.setText('Deseja Salvar?')
        ...
        if resposta == QMessageBox.Yes:
            ...
            self.msg.setText('Operação concluida com sucesso.')
            self.msg.exec()
        else:
            ...
            self.msg.setWindowTitle('MENSAGEM')
            self.msg.setText('Operação Cancelada!!')
            self.msg.exec()
